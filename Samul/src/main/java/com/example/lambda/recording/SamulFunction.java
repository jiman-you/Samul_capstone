...
public class SamulFunction implements RequestHandler<Document,   String> {
            private   DynamoDB   dynamoDb;
            private   String   DYNAMODB_TABLE_NAME   = "Samul";
            @Override
            ...
            private   String   persistData(Document   document) throws   ConditionalCheckFailedException   {
                        ...
                        return this.dynamoDb.getTable(DYNAMODB_TABLE_NAME)
                                                .putItem(new PutItemSpec().withItem(new Item()
                                                                        ...
                                                                        .withString("LAT",   document.current.state.reported.LAT)
                                                                        .withString("LON",   document.current.state.reported.LON)
